...
#define BOOST_TEST_MODULE Claim_Tx_Test

#include <boost/test/included/unit_test.hpp>
#include "../../src/structs/claim_tx.h"
...
namespace conclave
{
    ...
    BOOST_AUTO_TEST_CASE(ClaimTxConstructorsTest)
    {
        ClaimTx claimTxFromOutputs1(OUTPUTS_1, TRUSTEES_1, MIN_SIGS_1);
        ClaimTx claimTxFromOutputs2(OUTPUTS_2, TRUSTEES_2, MIN_SIGS_2);
        ClaimTx claimTxFromOutputsWithBitcoinTxid1(OUTPUTS_1, TRUSTEES_1, MIN_SIGS_1, FUNDING_OUTPOINT);
        ClaimTx claimTxFromOutputsWithBitcoinTxid2(OUTPUTS_2, TRUSTEES_2, MIN_SIGS_2, FUNDING_OUTPOINT);
    }
}
