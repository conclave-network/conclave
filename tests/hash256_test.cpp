...
namespace conclave
{
    ...
    {
        Hash256 hash("5942bb725f27989943d672de52bd92843723546fa835af2eef0c8ce5921611f0");
        BOOST_TEST(hash[0] == 0x59);
        BOOST_TEST(hash[1] == 0x42);
        BOOST_TEST(hash[2] == 0xbb);
        BOOST_TEST(hash[3] == 0x72);
        BOOST_TEST(hash[4] == 0x5f);
        BOOST_TEST(hash[5] == 0x27);
        BOOST_TEST(hash[6] == 0x98);
        BOOST_TEST(hash[7] == 0x99);
        BOOST_TEST(hash[8] == 0x43);
        BOOST_TEST(hash[9] == 0xd6);
        BOOST_TEST(hash[10] == 0x72);
        BOOST_TEST(hash[11] == 0xde);
        BOOST_TEST(hash[12] == 0x52);
        BOOST_TEST(hash[13] == 0xbd);
        BOOST_TEST(hash[14] == 0x92);
        BOOST_TEST(hash[15] == 0x84);
        BOOST_TEST(hash[16] == 0x37);
        BOOST_TEST(hash[17] == 0x23);
        BOOST_TEST(hash[18] == 0x54);
        BOOST_TEST(hash[19] == 0x6f);
        BOOST_TEST(hash[20] == 0xa8);
        BOOST_TEST(hash[21] == 0x35);
        BOOST_TEST(hash[22] == 0xaf);
        BOOST_TEST(hash[23] == 0x2e);
        BOOST_TEST(hash[24] == 0xef);
        BOOST_TEST(hash[25] == 0x0c);
        BOOST_TEST(hash[26] == 0x8c);
        BOOST_TEST(hash[27] == 0xe5);
        BOOST_TEST(hash[28] == 0x92);
        BOOST_TEST(hash[29] == 0x16);
        BOOST_TEST(hash[30] == 0x11);
        BOOST_TEST(hash[31] == 0xf0);
    }
}
