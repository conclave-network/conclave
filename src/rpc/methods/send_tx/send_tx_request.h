...
namespace conclave
{
    ...
    namespace rpc
    {
        ...
        SendTxResponse* sendTxHandler(const SendTxRequest&, ConclaveNode&);
        
        class SendTxRequest : public Request
        {
            public:
            ...
            {
                return sendTxHandler(*this, conclaveNode);
            }
            
            private:
            const static RpcMethod rpcMethod = RpcMethod::SendTx;
        };
    }
}
